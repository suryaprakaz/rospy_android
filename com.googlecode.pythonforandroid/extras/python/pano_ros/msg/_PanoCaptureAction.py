"""autogenerated by genpy from pano_ros/PanoCaptureAction.msg. Do not edit."""
import sys
...
class PanoCaptureAction(genpy.Message):
  _md5sum = "29aaf854ae11bc4f1d21580cf870cfb6"
  _type = "pano_ros/PanoCaptureAction"
...
"""
  ...
  _slot_types = ['pano_ros/PanoCaptureActionGoal','pano_ros/PanoCaptureActionResult','pano_ros/PanoCaptureActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PanoCaptureAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = pano_ros.msg.PanoCaptureActionGoal()
      if self.action_result is None:
        self.action_result = pano_ros.msg.PanoCaptureActionResult()
      if self.action_feedback is None:
        self.action_feedback = pano_ros.msg.PanoCaptureActionFeedback()
    else:
      self.action_goal = pano_ros.msg.PanoCaptureActionGoal()
      self.action_result = pano_ros.msg.PanoCaptureActionResult()
      self.action_feedback = pano_ros.msg.PanoCaptureActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.camera_topic
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.bag_filename
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2I.pack(_x.action_result.result.pano_id, _x.action_result.result.n_captures))
      _x = self.action_result.result.bag_filename
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_f.pack(self.action_feedback.feedback.n_captures))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.camera_topic = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.camera_topic = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.bag_filename = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.bag_filename = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (_x.action_result.result.pano_id, _x.action_result.result.n_captures,) = _struct_2I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.bag_filename = str[start:end].decode('utf-8')
      else:
        self.action_result.result.bag_filename = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (self.action_feedback.feedback.n_captures,) = _struct_f.unpack(str[start:end])
      return self
