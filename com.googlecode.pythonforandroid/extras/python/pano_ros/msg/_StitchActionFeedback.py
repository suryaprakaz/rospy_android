"""autogenerated by genpy from pano_ros/StitchActionFeedback.msg. Do not edit."""
import sys
...
class StitchActionFeedback(genpy.Message):
  _md5sum = "25bfb21ced59f4f9490772d56f6961f4"
  _type = "pano_ros/StitchActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pano_ros/StitchFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StitchActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = pano_ros.msg.StitchFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = pano_ros.msg.StitchFeedback()
