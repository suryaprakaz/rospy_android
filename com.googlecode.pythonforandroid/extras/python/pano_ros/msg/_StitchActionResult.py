"""autogenerated by genpy from pano_ros/StitchActionResult.msg. Do not edit."""
import sys
...
class StitchActionResult(genpy.Message):
  _md5sum = "243144fd08b12e77d7802b6a86215631"
  _type = "pano_ros/StitchActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pano_ros/StitchResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StitchActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = pano_ros.msg.StitchResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pano_ros.msg.StitchResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.result.result_flags))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.result_flags,) = _struct_i.unpack(str[start:end])
      return self
