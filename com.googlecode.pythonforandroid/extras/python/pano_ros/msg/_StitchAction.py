"""autogenerated by genpy from pano_ros/StitchAction.msg. Do not edit."""
import sys
...
class StitchAction(genpy.Message):
  _md5sum = "ab1d70bbe0a37cea2298db1374a78cfa"
  _type = "pano_ros/StitchAction"
...
================================================================================
MSG: pano_ros/StitchActionResult
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
...
================================================================================
MSG: pano_ros/StitchActionFeedback
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
...
"""
  ...
  _slot_types = ['pano_ros/StitchActionGoal','pano_ros/StitchActionResult','pano_ros/StitchActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StitchAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = pano_ros.msg.StitchActionGoal()
      if self.action_result is None:
        self.action_result = pano_ros.msg.StitchActionResult()
      if self.action_feedback is None:
        self.action_feedback = pano_ros.msg.StitchActionFeedback()
    else:
      self.action_goal = pano_ros.msg.StitchActionGoal()
      self.action_result = pano_ros.msg.StitchActionResult()
      self.action_feedback = pano_ros.msg.StitchActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.bag_file_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.stitch_file_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i3I.pack(_x.action_result.result.result_flags, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.bag_file_name = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.bag_file_name = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.stitch_file_name = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.stitch_file_name = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (_x.action_result.result.result_flags, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
