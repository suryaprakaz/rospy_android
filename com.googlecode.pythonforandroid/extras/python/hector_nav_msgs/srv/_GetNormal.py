...
class GetNormalResponse(genpy.Message):
  _md5sum = "8ea5d051594753307ebd995c02db60a3"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3df.pack(_x.normal.x, _x.normal.y, _x.normal.z, _x.yaw))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(_x))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(_x))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.normal.x, _x.normal.y, _x.normal.z, _x.yaw,) = _struct_3df.unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
class GetNormal(object):
  ...
  _md5sum = '78e9a71258a9d6fdc4aeba5a9c33a01e'
