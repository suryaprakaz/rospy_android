...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.diffs.header.seq, _x.diffs.header.stamp.secs, _x.diffs.header.stamp.nsecs))
      ...
      _x = self
      buff.write(_struct_6d.pack(_x.diffs.bounds.min_pt.latitude, _x.diffs.bounds.min_pt.longitude, _x.diffs.bounds.min_pt.altitude, _x.diffs.bounds.max_pt.latitude, _x.diffs.bounds.max_pt.longitude, _x.diffs.bounds.max_pt.altitude))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.diffs.header.seq, _x.diffs.header.stamp.secs, _x.diffs.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.diffs.bounds.min_pt.latitude, _x.diffs.bounds.min_pt.longitude, _x.diffs.bounds.min_pt.altitude, _x.diffs.bounds.max_pt.latitude, _x.diffs.bounds.max_pt.longitude, _x.diffs.bounds.max_pt.altitude,) = _struct_6d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.diffs.points = []
